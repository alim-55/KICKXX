...
class _AddProductState extends State<AddProduct> {
  ...
  final List<String> genderItems = ['nike', 'adidas', 'newbalance'];
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      reusableTextField("Enter Product name", null, false,
                          _productnameTextController, f1, f2, context, () {}),
                      ...
                      reusableTextField("Enter Brand name", null, false,
                          _brandNameTextController, f2, f3, context, () {}),
                      SizedBox(height: 10.0),
                      Container(
                          padding: EdgeInsets.only(left: 11),
                          child: const Text(
                      ...
                      reusableTextField("Enter Shoe Color", null, false,
                          _colorTextController, f3, f4, context, () {}),
                      SizedBox(height: 10.0),
                      Container(
                          padding: EdgeInsets.only(left: 11),
                          child: const Text(
                      ...
                      reusableTextField("Enter Product Price", null, false,
                          _productPriceTextController, f5, f6, context, () {}),
                      SizedBox(height: 10.0),
...
searchBackgroundColor: Colors.redAccent,
                  ...
                  selectedOptionIcon: const Icon(Icons.check_circle),
                    ...
                    children:<Widget> [
                      ...
                      SizedBox(height: 15),
                      firebaseButton(
                          context, "Add Product ", () => uploadProduct()),
                    ],
                  ),
                ),
              ),
  ...
  List<XFile?> _pickedImages =
      List.generate(3, (index) => null); // Adjust the size based on your needs
  ...
  Future<void> uploadProduct() async {
    try {
      if (_productPriceTextController.text.isEmpty ||
          _productDescriptionTextController.text.isEmpty ||
          _brandNameTextController.text.isEmpty ||
          _colorTextController.text.isEmpty) {
      ...
      if (productImages.length != 3) {
        ...
        Fluttertoast.showToast(
          msg: 'Please select exactly three images',
          gravity: ToastGravity.TOP,
        );
        return;
      }
      ...
      final productInfo = {
        ...
        'shoeSizes': _shoeSizeController.selectedOptions
            .map((item) => item.label)
            .toList(),
